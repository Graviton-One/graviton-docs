...
Two years ago, VentuaryLab stood at the origins of USD Neutrino, or [USDN](https://coinmarketcap.com/ru/currencies/neutrino-usd/), currently one of the top-10 stablecoins, the first stablecoin on the Waves blockchain and the second algorithmic stablecoin by TVL after DAI \(currently owned and managed by Waves.Exchange\). The experience of expanding USDN beyond its native ecosystem involved researching other networks besides Waves in an effort to establish liquidity and traction there. Apart from tech-layer obstacles connected with the necessity to provide a decentralised way of porting the Waves-based token onto other networks, USDN’s inter-chain growth had been restrained by the unwillingness of the new communities to acknowledge this new product and give it endorsement and initial liquidity.
